//! Build script to generate compile-time instruction reference metadata.
//!
//! Only the instruction info map is generated at build time; semantics are
//! frozen in `src/semantics.rs` to avoid depending on doc parsing.
...
fn main() {
    ...
    writeln!(
        ...
        "/// Information about a Miden assembly instruction.\n\
         ...
         pub struct InstructionInfo {{\n\
             ...
             pub stack_input: &'static str,\n\
             pub stack_output: &'static str,\n\
    ...
    writeln!(
        ...
        "/// Compile-time generated instruction reference map.\n\
         ...
         #[allow(dead_code)]\n\
         pub static INSTRUCTION_MAP: phf::Map<&'static str, InstructionInfo> = {};",
        builder.build()
    )
    .unwrap();
}
