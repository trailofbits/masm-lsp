...
//! - `call_graph`: Call graph construction and topological ordering
...
// Re-export stack helpers
pub use masm_instructions::{StackLike, StackLikeResult, StackOp, StackOpExt};
